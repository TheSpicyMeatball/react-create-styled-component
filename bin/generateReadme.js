...
const generateSummaryTable = utils => (
  `<table>
    ...
    <tbody>` +
    utils.map(x => (
      `<tr><td><a href="https://github.com/TheSpicyMeatball/react-create-styled-component/tree/main/src/${x.name.replace('Deep', '')}/README${x.name.includes('Deep') ? '-deep' : ''}.md">${x.name}</a></td>` +
